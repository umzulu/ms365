package com.beiyanght.ms365.employment;
...
@Path(value="/employment")
public class EmploymentServlet {
	...
	public Viewable index(@PathParam(value="path") String path, @DefaultValue("0") @QueryParam("start") Integer start) throws Exception{
		if (!"index".equals(path)) {
			...
			return new Viewable("/employment/"+path, data);
		}
		return new Viewable("/employment/employment");
	}
