package com.beiyanght.ms365.education;
...
@Path(value="/education")
public class EducationServlet {
	...
	public Viewable index(@PathParam(value="path") String path, @DefaultValue("0") @QueryParam("start") Integer start) throws Exception{
		if (!"index".equals(path)) {
			...
			return new Viewable("/education/"+path, data);
		}
		return new Viewable("/education/education");
	}
